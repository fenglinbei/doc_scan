...
const RESULT_ITEMS: ResultItem[] = [
  ...
  { key: "final", label: "最终结果", description: "默认采用 Sauvola 后处理结果" }
];

const PRIMARY_ARTIFACTS: ArtifactKey[] = ["corner_detection", "rectified", "morphology_enhanced", "final"];
...
const PROCESSING_MESSAGES = ["正在定位文档边界", "正在做透视矫正", "正在校正光照", "正在生成二值化对照"];
